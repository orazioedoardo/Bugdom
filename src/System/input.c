...
#if __APPLE__
	#define DEFAULT_MORPH_SCANCODE1 SDL_SCANCODE_LALT
	#define DEFAULT_MORPH_SCANCODE2 SDL_SCANCODE_RALT
	#define DEFAULT_KICK_SCANCODE1 SDL_SCANCODE_LGUI
	#define DEFAULT_KICK_SCANCODE2 SDL_SCANCODE_RGUI
#else
	#define DEFAULT_MORPH_SCANCODE1 SDL_SCANCODE_LCTRL
	#define DEFAULT_MORPH_SCANCODE2 SDL_SCANCODE_RCTRL
...
[kKey_MorphPlayer		] = { "Morph Into Ball",	DEFAULT_MORPH_SCANCODE1,DEFAULT_MORPH_SCANCODE2,SDL_BUTTON_MIDDLE,	SDL_CONTROLLER_BUTTON_B, },
[kKey_BuddyAttack		] = { "Buddy Attack",		SDL_SCANCODE_TAB,		0,						0,					SDL_CONTROLLER_BUTTON_Y, },
[kKey_Jump				] = { "Jump / Boost",		SDL_SCANCODE_SPACE,		0,						SDL_BUTTON_RIGHT,	SDL_CONTROLLER_BUTTON_A, },
